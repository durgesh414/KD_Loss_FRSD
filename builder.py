...
#from utils import get_rank  #is_dist, get_world_size, get_rank
...
def build_module(cfg, module):
    ...
    if 'pretrained' in cfg:
        net.load_state_dict(torch.load(cfg['pretrained'], map_location=device))
    ...
    return {'net': net, 'clip_grad_norm': clip_grad_norm, 'optimizer': optimizer, 'scheduler': scheduler}
