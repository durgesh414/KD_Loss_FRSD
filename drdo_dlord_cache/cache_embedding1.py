...
def parse_args():
    ...
    parser.add_argument('--config', help='config file for testing datasets', required=True)
...
def main_worker(config, model_namee, classs, proj_dir):
    ...
    # config['project']['proj_dirs'] = proj_dir
    # print(config['project']['proj_dirs'])
...
if __name__ == '__main__':
    ...
    config['data']['image_folder'] = "/home/kaushik/Durgesh/drdo-faces/og_all_5m" 
    model_namee = args.model_name
    classs = "neg"
    proj_dir = args.proj_dirs

    main_worker(config, model_namee, classs, proj_dir)
